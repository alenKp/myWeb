...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_article_manage'] = $this->language->get('text_article_manage');
		$data['text_article_category'] = $this->language->get('text_article_category');


		$data['article_category'] = $this->url->link('article/category', 'token=' . $this->session->data['token'],true);
		...
		$data['weidian_product'] = $this->url->link('weidian/product', 'token=' . $this->session->data['token'], true);
		$data['weidian_config'] = $this->url->link('weidian/config', 'token=' . $this->session->data['token'], true);
		$data['pushurl'] = $this->url->link('baidu/pushurl', 'token=' . $this->session->data['token'], true);
		$data['youzan_product'] = $this->url->link('youzan/product', 'token=' . $this->session->data['token'], true);
		$data['youzan_config'] = $this->url->link('youzan/config', 'token=' . $this->session->data['token'], true);
		$data['press_category'] = $this->url->link('cms/press_category', 'token=' . $this->session->data['token'], true);
		$data['press'] = $this->url->link('cms/press', 'token=' . $this->session->data['token'], true);
		$data['press_config'] = $this->url->link('cms/press_config', 'token=' . $this->session->data['token'], true);
		$data['blog'] = $this->url->link('cms/blog', 'token=' . $this->session->data['token'], true);
		$data['blog_category'] = $this->url->link('cms/blog_category', 'token=' . $this->session->data['token'], true);
		$data['blog_comment'] = $this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'], true);
		$data['blog_config'] = $this->url->link('cms/blog_config', 'token=' . $this->session->data['token'], true);
		$data['faq'] = $this->url->link('cms/faq', 'token=' . $this->session->data['token'], true);
		$data['faq_category'] = $this->url->link('cms/faq_category', 'token=' . $this->session->data['token'], true);
		$data['faq_config'] = $this->url->link('cms/faq_config', 'token=' . $this->session->data['token'], true);
		$data['excelexportimport'] = $this->url->link('tool/excelexportimport', 'token=' . $this->session->data['token'], true);
